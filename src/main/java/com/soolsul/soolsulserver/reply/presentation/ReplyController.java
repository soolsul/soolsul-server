...
public class ReplyController {
    ...
    @PostMapping
    public ResponseEntity<BaseResponse<Void>> createReply(@Valid @RequestBody PostReplyRequest request, @PathVariable String postId, Authentication authentication) {
        CustomUser customUser = (CustomUser) authentication.getPrincipal();
        replyFacadeGateway.create(customUser.getId(), postId, request);
